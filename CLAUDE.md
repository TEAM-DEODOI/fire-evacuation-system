...
- D-NEW-001: Drone swarm adopted (replaces single Crazyflie). `gym-pybullet-drones`
  multi-agent, Boids/APF collision avoidance, PSO mission assignment.
- D-NEW-002: EXP-PATH-001 expanded to three scenarios (S1 fixed sign / S2 FDS swarm /
  S3 PI-FNO swarm). S1 vs S2 = H6. S2 vs S3 = H5 guidance quality.
- D-NEW-003: PersonAgent uses simplified movement model only (constant 1.2 m/s,
  wall contact avoidance). No panic, no social force. See NOT DO section.
